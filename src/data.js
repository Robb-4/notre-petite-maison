...
export default {
  ...
  sequences: {
    ...
    date_baiser: [
      ...
      { qui: "partner", texte: "C'est le plus beau coucher de soleil que j'aie jamais vu." },
  ...
  dialogues: {
    ...
    use_parasol: { any: ["À l'ombre, face à l'Adriatique. Le luxe."] },
  ...
  quests: [
    ...
    },
    {
      ...
      steps: [
        ...
        { target: "stove", label: "Cuisiner des tacos" },
